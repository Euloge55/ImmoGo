...
<head>
    ...
    <title>ImmoGo - @yield('title', 'Gestion Immobilière')</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand fw-bold fs-4" href="{{ route('home') }}">
                <i class="fas fa-building me-2" style="color:#4ECDC4"></i>ImmoGo
            </a>
    ...
    <footer class="mt-5 py-4" style="background-color:#2C3E50; color:white;">
        <div class="container text-center">
            <p class="mb-0">
                ...
                <strong>ImmoGo</strong> — Application de Gestion Immobilière
            </p>
